//
//  CGMineChuBeiCustomerViewController.m
//  ChengGeLeasing
//
...
@interface CGMineChuBeiCustomerViewController ()<CGCustomerTopViewDelegate>
{
    //搜索关键词
    NSString *keywordStr;
    //A-Z
...
@implementation CGMineChuBeiCustomerViewController
...
- (CGCustomerTopView *)topView {
    if(!_topView) {
        _topView = [[CGCustomerTopView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 150) isXiangmu:NO];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *cellIndentifier = @"CGChuBeiCustomerCell";
    CGChuBeiCustomerCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIndentifier];
    if (cell == nil) {
        cell = [[CGChuBeiCustomerCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIndentifier];
    }
...
- (void)swipeableTableViewCell:(SWTableViewCell *)cell didTriggerRightUtilityButtonWithIndex:(NSInteger)index {
    ...
    CGChuBeiCustomerCell *tCell = (CGChuBeiCustomerCell *)cell;
