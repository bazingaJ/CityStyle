//
//  CGMineMessageUpcomingDetailViewController.m
//  ChengGeLeasing
//
...
@interface CGMineMessageUpcomingDetailViewController ()

@end

@implementation CGMineMessageUpcomingDetailViewController
...
- (void)showInWebView {
    ...
    [html appendFormat:@"<link rel=\"stylesheet\" href=\"%@\">",[[NSBundle mainBundle] URLForResource:@"ChengGeLeasing.css" withExtension:nil]];
    [html appendString:@"</head>"];
...
- (NSString *)touchBody {
    ...
    [body appendFormat:@"<div class=\"title\">%@</div>",self.messageInfo.content];
    [body appendFormat:@"<div class=\"time\">%@</div>",self.messageInfo.time];
