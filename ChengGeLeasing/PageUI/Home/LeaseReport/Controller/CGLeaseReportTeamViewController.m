//
//  CGLeaseReportTeamViewController.m
//  ChengGeLeasing
//
...
@interface CGLeaseReportTeamViewController ()

@property (nonatomic, strong) CGLeaseReportMyModel *model;

@end

@implementation CGLeaseReportTeamViewController
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    //创建总拜访
    UILabel *lbMsg3 =[[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH -120-45-10, 0, 110, 45)];
    lbMsg3.font = FONT14;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if (indexPath.section ==2)
    {
        ...
        lbMsg3.font = FONT14;
        lbMsg3.textColor = COLOR9;
        lbMsg3.text = [NSString stringWithFormat:@"意向铺位:%@",model.pos_name];
        [cell.contentView addSubview:lbMsg3];
        
        //创建"日期"
        UILabel *lbMsg4 =[[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH -80, lbMsg2.top,70, 15)];
        lbMsg4.text =  model.time;
        lbMsg4.font = FONT14;
        lbMsg4.textColor = COLOR9;
        lbMsg4.textAlignment = NSTextAlignmentRight;
        [cell.contentView addSubview:lbMsg4];
        ...
        //创建'名字"
        UILabel *lbMsg5 =[[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH -80, lbMsg4.bottom+5,70, 15)];
        lbMsg5.text =  model.linkman_name;
        lbMsg5.font = FONT14;
        lbMsg5.textColor = COLOR9;
        lbMsg5.textAlignment = NSTextAlignmentRight;
        [cell.contentView addSubview:lbMsg5];
        ...
        lbMsg6.text = [NSString stringWithFormat:@"意向度:%@%%",model.intent];
        lbMsg6.font = FONT14;
        lbMsg6.textColor = COLOR9;
        [cell.contentView addSubview:lbMsg6];
        
        //创建"事项详情"
        UILabel *lbMsg7 =[[UILabel alloc]initWithFrame:CGRectMake(15, lbMsg6.bottom+5, SCREEN_WIDTH-30, model.cellHeight)];
...
-(void)goToBtnClick:(UIButton *)sender
{
    switch (sender.tag) {
        ...
        case 11:
        {
            ...
            customerFunnelView.fromWhere = @"3";
            ...
            
        {
            CGPerformanceRankViewController *performanceRankView =[[CGPerformanceRankViewController alloc]init];
             performanceRankView.fromWhere = @"3";
