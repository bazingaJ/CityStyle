...
//  ChengGeLeasing
//
//  Created by yunduopu-ios-2 on 2018/4/8.
...
@interface CGPlayerViewController ()<ZFPlayerDelegate,ZFDownloadDelegate>
/** 播放器View的父视图*/
...
- (void)viewDidLoad
{
    ...
    [self zf_playerDownload:self.videoURL.absoluteString];
}
...
- (ZFPlayerModel *)playerModel {
    if (!_playerModel) {
        ...
        _playerModel.placeholderImage = nil;//[UIImage imageNamed:@"loading_bgView1"];
...
- (void)finishedDownload:(ZFHttpRequest *)request
{
    ...
    ZFFileModel *model                 = self.downloadObjectArr[0][0];
    // 文件存放路径
